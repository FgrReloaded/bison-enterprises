...
import { getTotalOrderAmount, getTotalOrders } from "@/actions/admin/orders";
import { getTotalCustomers } from "@/actions/admin/user";
...
const StatsCard = () => {
    ...
    const { data: orderAmount } = useQuery({
        queryKey: ['total-order-amount'],
        ...
        <>
            <div className="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
                ...
                <div className="p-4 text-right">
                    ...
                    <h4 className="block antialiased tracking-normal font-sans text-2xl font-semibold leading-snug text-blue-gray-900">₹ {orderAmount ? orderAmount?.totalAmount:0}</h4>
                </div>
            ...
            <div className="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
                ...
                <div className="p-4 text-right">
                    ...
                    {typeof customerCount === 'number' ? (
                      <h4 className="block antialiased tracking-normal font-sans text-2xl font-semibold leading-snug text-blue-gray-900">{totalOrders}</h4>
                    ) : (
            ...
            <div className="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
                ...
                <div className="p-4 text-right">
                    <p className="block antialiased font-sans text-sm leading-normal font-normal text-blue-gray-600">Total Customer</p>
                    <h4 className="block antialiased tracking-normal font-sans text-2xl font-semibold leading-snug text-blue-gray-900">{JSON.stringify(customerCount) ?? 0}</h4>
                </div>
                <div className="border-t border-blue-gray-50 p-4">
                    <p className="block antialiased font-sans text-base leading-relaxed font-normal text-blue-gray-600">
            ...
            <div className="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
                ...
                <div className="p-4 text-right">
                    <p className="block antialiased font-sans text-sm leading-normal font-normal text-blue-gray-600">Traffic</p>
