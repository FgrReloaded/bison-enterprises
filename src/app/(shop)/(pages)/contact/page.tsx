...
export default function ContactPage() {
    return (
        <div className="mt-6 max-w-6xl max-lg:max-w-3xl mx-auto bg-gray-800 rounded-lg">
            <div className="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
                <div>
                    <h1 className="text-4xl font-bold text-white">Get in Touch</h1>
                    <p className="text-sm text-gray-300 mt-4 leading-relaxed">
                        Send us a message and we will get back to you as soon as possible. You can also reach us through
                    </p>
                    ...
                    <ul className="mt-12 space-y-8">
                        ...
                        <li className="flex items-center">
                            ...
                            <a href="javascript:void(0)" className="text-white text-sm ml-4">
                                Chaumuha Road, Mathura, Uttar Pradesh, India
                            </a>
                        </li>
                    </ul>

                    <ul className="flex mt-12 space-x-4">
                        <li className="bg-gray-600 hover:bg-gray-950 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                ...
                <div className="bg-gray-100 p-6 rounded-lg">
                    ...
                    <form className="mt-8 space-y-4">
                        ...
                        <Button type='button'
                            className="text-white bg-gray-600 hover:bg-gray-950 tracking-wide rounded-lg text-sm px-4 py-3 flex items-center justify-center w-full !mt-6">
