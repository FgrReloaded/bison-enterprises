                        ...
                        <div className="lg:flex lg:items-start">
                            <div className="lg:order-2 lg:ml-5">
                                <div className="w-[650px] h-[600px] overflow-hidden relative">
                                    <Image layout="fill" className="rounded-lg" objectFit="cover" src="/assets/dev/image.png" alt="" />
                                </div>
                            </div>

                            <div className="mt-2 w-full lg:order-1 lg:w-32 lg:flex-shrink-0">
                                <div className="flex flex-row items-start lg:flex-col">
                                    <button type="button" className="flex-0 aspect-square mb-3 h-20 overflow-hidden rounded-lg border-2 border-gray-900 text-center relative">
                                        <Image layout="fill" objectFit="cover" className="h-full w-full object-cover" src="/assets/dev/quick.jpeg" alt="" />
                                    </button>
                                    <button type="button" className="flex-0 aspect-square mb-3 h-20 overflow-hidden rounded-lg border-2 border-transparent text-center relative">
                                        <Image layout="fill" objectFit="cover" className="h-full w-full object-cover" src="/assets/dev/quick.jpeg" alt="" />
                                    </button>
                                    <button type="button" className="flex-0 aspect-square mb-3 h-20 overflow-hidden rounded-lg border-2 border-transparent text-center relative">
                                        <Image layout="fill" objectFit="cover" className="h-full w-full object-cover" src="/assets/dev/quick.jpeg" alt="" />
