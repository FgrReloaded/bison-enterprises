            ...
            <div className="w-full  px-4 md:px-5 lg-6 mx-auto">
                <div className="w-full">
                    ...
                    <div className="pt-11 pb-8 border-b border-gray-100 max-xl:max-w-2xl max-xl:mx-auto">
                        ...
                        <div className="flex sm:items-center flex-col min-[400px]:flex-row justify-between gap-5 mb-4">
                            <div className="flex items-center gap-3 relative">
                                <Image width={50} height={50} objectFit="cover" src="/assets/dev/slide01.jpeg" alt="John image" className="w-8 h-8 rounded-full" />
                    ...
                    <div className="pt-8 max-xl:max-w-2xl max-xl:mx-auto">
                        ...
                        <div className="flex sm:items-center flex-col min-[400px]:flex-row justify-between gap-5 mb-4">
                            <div className="flex items-center gap-3 relative">
                                <Image width={50} height={50} objectFit="cover" src="/assets/dev/slide01.jpeg" alt="Robert image" className="w-8 h-8 rounded-full" />
